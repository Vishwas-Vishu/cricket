...
<body>
  ...
  <div id="image" class="p-5" style="background:url(ground.jpeg) no-repeat center fixed;min-height: 650px;">
    <div class="container pd">
      <div class="row col-12">
        <div class="offset-1 col-6">
          <h5 style="color:antiquewhite">New User Sign up</h5> <br>
          <form action="" method="post">
            ...
            <div class="form-group my-2">
              <label for="userid" style="color:antiquewhite">User Name :</label>
