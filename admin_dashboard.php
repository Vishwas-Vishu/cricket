...
<body>
  ...
  <div class="" style="background:url(ground.jpeg) no-repeat center fixed">
    <h1 class="display-3 py-2" style="text-align:center;font-weight:500;color:antiquewhite">Welcome to Super 11
      Cricket Academy</h1>

    <div class="col-auto">
      <div class="row">
        <div class=" offset-2 col-md-8 pd1">
          <div class="card border-dark">
            <h6 class="card-header" style="font-size:25px;">Total no of Users :
              <?php echo get_user_count(); ?></h6>
            <div class="card-body">
              <a type="button" class="btn btn-block btn-outline-warning btn-lg mx-3" href="show_user.php">Show users</a>
            </div>
          </div>
        </div>
        ...
        <div class="offset-2 col-md-8 pd">
          <div class="card border-dark">
            <h6 class="card-header" style="font-size:25px;">Total No of Participants :
              <?php echo get_par_count() ?></h6>
            <div class="card-body">
              &nbsp &nbsp
              <a type="button" class="btn btn-outline-primary btn-lg" href="participant.php">&nbsp &nbsp Add Participant
                &nbsp
                &nbsp</a> &nbsp &nbsp
              <a type="button" class="btn btn-outline-warning btn-lg" href="ashow_Participant.php">&nbsp &nbsp Show
                Participant
                &nbsp
                &nbsp</a>
            </div>
        ...
        <div class="offset-2 col-md-8 pd">
          <div class="card border-dark">
            <h6 class="card-header" style="font-size:25px;">Total no of Coaches :
              <?php echo get_coach_count() ?></h6>
            <div class="card-body">
              &nbsp &nbsp
              <a type="button" class="btn btn-outline-primary btn-lg" href="coaches.php">&nbsp &nbsp Add Coach &nbsp
                &nbsp</a> &nbsp &nbsp
              <a type="button" class="btn btn-outline-warning btn-lg" href="ashow_coach.php">&nbsp &nbsp Show Coaches
                &nbsp
                &nbsp</a>
            </div>
          </div>
        ...
        <div class="offset-2 col-md-8 pd">
          <div class="card border-dark">
            <h6 class="card-header" style="font-size:25px;">Total no of Participants Taken
              Courses : <?php echo get_courses_count() ?></h6>
            <div class="card-body">
              &nbsp
              <a type="button" class="btn btn-outline-primary btn-lg" href="course_regis.php">&nbsp Add Course to the
                Partcipant
                &nbsp
              </a> &nbsp &nbsp
              <a type="button" class="btn btn-outline-warning btn-lg" href="ashow_parCoach.php"> Show Participant with
                Course</a>
            </div>
          </div>
        </div>
