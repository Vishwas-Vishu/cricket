...
<body>
  ...
  <div id="image" class="p-5" style="background:url(ground.jpeg) no-repeat center fixed;min-height: 700px;">
    <div class="container pd">
      <div class="row col-12">
        <div class="offset-1 col-6">
          <h5 style="color:antiquewhite">Admin login</h5> <br>
          <form action="" method="post">
            <div class="form-group">
              <label for="userid" style="color:antiquewhite">User Id :</label>
            ...
            <button type="submit" name="Login" class="btn btn-primary btn-lg my-2"> Admin Login</button>
          </form>
        </div>
      </div>
